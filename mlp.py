...
uk_comfirmed_data_norm = uk_comfirmed_data / 40000

# fit model
model.fit(uk_dates, uk_comfirmed_data_norm, epochs=1000)

uk_comfirmed_data_predict = model.predict(uk_dates)
uk_comfirmed_data_predict = uk_comfirmed_data_predict * 40000
fig1 = plt.figure(figsize=(7, 5))
