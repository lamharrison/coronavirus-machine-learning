...
# set italy absorb
italy_absorb = corn_y[italy_dates_length-1]*1.5
...
ger_absorb = ger_corn_y[ger_dates_length-1]*1.5
...
fr_absorb = fr_corn_y[fr_dates_length-1]*1.5
...
uk_comfirmed_data.append(114217)
...
uk_absorb_amount = uk_comfirmed_data[uk_date_length-1]*2.3
